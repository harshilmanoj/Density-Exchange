...
const Featured = () => {
  return (
    <div className="container pt-40">
      <h2 className="text-6xl font-bold">Does</h2>
      <h2 className="text-6xl font-bold pt-2">
        this sound <span className="text-accent">Familiar</span>
      </h2>
      ...
      <div className="grid md:grid-cols-[1fr,37%,1fr] gap-16 mt-10">
        <div className="w-fit mx-auto self-end">
          ...
          <div className="space-y-4">
            <Dash />
            <h2 className="font-medium text-xl">Page 1</h2>
        ...
        <div className="w-fit mx-auto">
          ...
          <div className="space-y-4">
            <Dash />
            <h2 className="font-medium text-xl">Page 2</h2>
            <p className="text-gray-700 text-[14px] xl:text-[16px]">
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
              Dignissimos, nesciunt distinctio.
            </p>
        ...
        <div className="w-fit mx-auto self-end">
          ...
          <div className="space-y-4">
            <Dash />
            <h2 className="font-medium text-xl">Page 3</h2>
            <p className="text-gray-700 text-[14px] xl:text-[16px]">
              Lorem ipsum dolor sit amet consectetur adipisicing elit.
              Dignissimos, nesciunt distinctio.
            </p>
